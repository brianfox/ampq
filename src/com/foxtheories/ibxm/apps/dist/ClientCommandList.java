...
public enum ClientCommandList {
    ...
    static {
        ...
        int maxcommand = 0;
        for (ClientCommandList c : ClientCommandList.values()) {
    ...
    ClientCommandList(String title, String regex, Type type, String help)
	{ 
		this.title = title;
	...
	public static ClientCommandList fromString(String s) {
